...
\tikzstyle{powerL} = [draw,color=red!80,thick]
\tikzstyle{powerB} = [->,ultra thick,draw,color=red!80]
\tikzstyle{dataL} = [draw,color=blue,very thick]
...
\tikzstyle{hardware} = [rectangle, draw, fill=blue!30, text width=5em, text centered,minimum height=4em,on chain]
\tikzstyle{CPU} = [draw=black,fill=blue!60,inner sep=0]
