...
\tikzstyle{power} = [rectangle, draw, fill=red!80, text width=5em, text centered, minimum height=4em,node distance=2cm]
\tikzstyle{prog} = [rectangle, draw, fill=red!20, text width=5em, text centered, minimum height=4em,node distance=2cm]
\tikzstyle{perif} = [rectangle, draw, fill=green!40, text width=5em, text centered, minimum height=4em,node distance=2cm]
\tikzstyle{hardware} = [rectangle, draw, fill=blue!80, text width=5em, text centered, minimum height=4em,node distance=2cm]
