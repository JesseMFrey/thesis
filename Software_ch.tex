...
\future{write some code for these commands. It is still not 100\% clear how commands will be sent so I'll just have to make that up then write about how the command works.}
...
\future{Perhaps impliment this and write about how it went or add some more vague words.}
...
\subsection{Mode 1 (B-dot)}

\future{Implement this and write about it}
...
\future{This will almost certainly not exist by the end of the summer. Add more speculative words?}
...
\future{Talk about MSP430 specific implementation details and transferring calibration to MSP (I think this will be done strait from Matlab).}
