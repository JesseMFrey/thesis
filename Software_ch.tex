...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\linewidth]{torqueCalTst}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\linewidth]{torqueCalTst-err}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\linewidth]{torqueOffsets}
