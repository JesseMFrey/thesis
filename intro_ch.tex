...
\Cref{ch:Helmholtz} describes the Helmholtz cage used for testing of the system. The Helmholtz cage is capable of generating a uniform magnetic field in any direction and is used for testing of the magnetometer.
