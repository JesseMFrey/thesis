...
\begin{figure}[!ht]
    ...
    \end{minipage}\begin{minipage}{0.35\linewidth}
        \begin{tikzpicture}[remember picture] 
            ...
            \fill[blue,fill opacity=0.3] (1.339,1.07) -- (1.45,1.05) -- (1.45,0.91) -- (1.345,0.93) -- cycle;
            \path ( 1.335, 1.00) coordinate (MAG)
                  (-1.930,-0.08) coordinate (XT)
                  (-1.140, 0.00) coordinate (YT)
                  (-2.430,-0.23) coordinate (ZT1)
                  (-0.160,-0.52) coordinate (ZT2);
        \end{tikzpicture}
    \end{minipage}
...
\begin{figure}[!ht]
    ...
    \begin{minipage}{0.35\linewidth}
        \begin{tikzpicture}[remember picture] 
            \def\sysx{1.8}
            \pgftext{\includegraphics[width=\linewidth]{SPB}}
            \path (1.30,1.62) coordinate (MAG)
                  (-0.64,1.62) coordinate (ADC)
                  (-0.65,1.12) coordinate (AMP)
                  (1.48,0.18) coordinate (ACC)
                  (00.68,0.58) coordinate (DAT);
        \end{tikzpicture}
