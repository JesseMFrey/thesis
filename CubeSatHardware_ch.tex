...
\begin{figure}[!ht]
    ...
    \begin{minipage}{0.38\linewidth}
        \raggedleft
        \begin{itemize}\setlength{\parskip}{0pt}
            \item[\kern-0.2em] Z2 \tikz[na] \coordinate (Z2i);

            \item[\kern-0.2em] X1 \tikz[na] \coordinate (X1i);
            \item[\kern-0.2em] X2 \tikz[na] \coordinate (X2i);
            \item[\kern-0.2em] X3 \tikz[na] \coordinate (X3i);
            \item[\kern-0.2em] X4 \tikz[na] \coordinate (X4i);

            \item[\kern-0.2em] Z1 \tikz[na] \coordinate (Z1i);
        \end{itemize}
    \end{minipage}\begin{minipage}{0.35\linewidth}
        \begin{tikzpicture}[remember picture] 
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\linewidth]{ACDS-board-render}};
    ...
    \end{minipage}\begin{minipage}{0.30\linewidth}
        \begin{itemize}\setlength{\parskip}{0pt}
            \item[\kern-0.2em] \tikz[na] \coordinate (Z3i); Z3

            \item[\kern-0.2em] \tikz[na] \coordinate (Y2i); Y2
            \item[\kern-0.2em] \tikz[na] \coordinate (Y1i); Y1
            \item[\kern-0.2em] \tikz[na] \coordinate (Y3i); Y3
            \item[\kern-0.2em] \tikz[na] \coordinate (Y4i); Y4

            \item[\kern-0.2em] \tikz[na] \coordinate (Z4i); Z4
        \end{itemize}
    \end{minipage}
