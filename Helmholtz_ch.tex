...
\Cref{fig:hc-tst-err} shows the magnetic field error from the testing in \cref{fig:hc-tst}. The total RMS error for the plot is 9.4~mGauss. There are a few large error spikes that may be attributed to the position of the elevator or fire doors which are just outside the lab.
